...
mylist = FileUtils.loadListFromFile ('miniAOD-M2M3-Fede-with-List3.txt')
...
#				'file:root://se01.indiacms.res.in:1094//cms/store/user/digupta/BctoDsMuMu_MC_MINIAOD/BctoDsMuMu_MC_MINIAOD_105.root',
				mylist,
...
#       fileName = cms.string('Test_MC.root'),
      fileName = cms.string('BctoDsMuMu_5k_3.root'),
