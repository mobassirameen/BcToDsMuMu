...
config.General.requestName = 'job_crab_data_Charmonium_finaljob_MINIAOD_CMSSW10218_18C_v1_Jhovanny'
config.General.workArea = 'crab_data_Charmonium_finaljob_MINIAOD_CMSSW10218_18C_v1_Jhovanny'
config.General.transferOutputs = True
config.General.transferLogs = False

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'Psiks0Rootupler_A.py'
