...
export RECREL=CMSSW_10_2_12
export SCRAM_ARCH=slc7_amd64_gcc700


export FILE1=file:root://se01.indiacms.res.in:1094//cms/store/user/digupta/BctoDsMuMu_MC_MINIAOD_5k/$1
...
export FILE2=file:BctoDsMuMu_MC_$2.root
...
pwd
date
eval `scramv1 project CMSSW CMSSW_10_2_12`
...
mv ../../../../../BcToDsMuMuRootupler.py  step1.py
...
xrdcp BctoDsMuMu_MC_$2.root root://se01.indiacms.res.in:1094//cms/store/user/digupta/BctoDsMuMu_MC_Fin/BctoDsMuMu_MC_$2.root
